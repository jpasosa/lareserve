          ...
          <div class="form-box">
            <div class="bottom">
			  ...
			  <hr  class="hr"/>
				...
				<div class="form-row">
                  <input type="text" name="NombreComprador" id="nombre" disabled size="30" value="<?php if (isset($gift['NombreComprador'])): echo $gift['NombreComprador'];endif; ?>" title="campo obligatorio" required class="text login_input"  placeholder="¿Cómo te llamás?">
                </div>
                <div class="form-row">
                  <input type="text" name="ApellidoComprador" id="apellido" disabled size="30" value="<?php if (isset($gift['ApellidoComprador'])): echo $gift['ApellidoComprador'];endif; ?>" title="campo obligatorio" required class="text login_input"  placeholder="¿Y tu apellido?">
                </div>
                <div class="form-row">
                  <input type="email" name="EmailComprador" id="email" title="email incorrecto" disabled size="30" value="<?php if (isset($gift['EmailComprador'])): echo $gift['EmailComprador'];endif; ?>" required class="text login_input"  placeholder="Escribí acá tu mail para luego reenviar al agasajado">
                </div>
                <div class="form-row">
                  <input type="text" name="TelefonoComprador" id="telefono" disabled size="30" value="<?php if (isset($gift['TelefonoComprador'])): echo $gift['TelefonoComprador'];endif; ?>" class="text login_input"  required placeholder="Y acá indicanos tu teléfono">
				</div>
                <div class="form-row">
                  <input type="text" name="NombreAgasajado" id="nombre_para" disabled size="30" value="<?php if (isset($gift['NombreAgasajado'])): echo $gift['NombreAgasajado'];endif; ?>" title="campo obligatorio" required class="text login_input"  placeholder="¿Cómo se llama quien recibe el regalo?">
                </div>
                <div class="form-row">
                  <input type="text" name="ApellidoAgasajado" id="apellido_para" disabled size="30" value="<?php if (isset($gift['ApellidoAgasajado'])): echo $gift['ApellidoAgasajado'];endif; ?>" class="text login_input"  placeholder="¿Su apellido?">
                </div>
                <div class="form-row">
                  <textarea name="MensajePersonalizado" id="mensaje" required  disabled title="campo obligatorio" maxlength="150" placeholder="Escribí acá un mensaje personalizado (Por ej: Feliz Día de la Madre!)"><?php if (isset($gift['MensajePersonalizado'])): echo $gift['MensajePersonalizado'];endif; ?>
</textarea>
                </div>
...
<script src="<?php echo base_url() . TEMPLATE_ASSETS; ?>js/jquery.h5validate.js"></script>
