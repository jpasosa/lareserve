		...
		<div class="row">
			<div class="span6">
				...
				<div class="form-row">
								...
								<div class="form-row">
									<textarea name="MensajePersonalizado" id="mensaje"  required  disabled title="Ingresa el mensaje personalizado" maxlength="150" placeholder="Escribí acá un mensaje personalizado (Por ej: Feliz Día de la Madre!)"><?php if (isset($gift['MensajePersonalizado'])): echo $gift['MensajePersonalizado'];endif; ?></textarea>
								</div>
								<?php if ( isset($gift['cantidad']) && $gift['cantidad'] == 1 ): ?>
